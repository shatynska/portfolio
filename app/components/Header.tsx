...
export default function Header() {
  return (
    <header className="flex flex-col md:flex-row">
      <Cell className="h-screen max-h-192 min-h-128 gap-44 bg-primary-900 bg-[url('/backgrounds/line-dark.svg')] bg-contain bg-center bg-no-repeat px-14 text-primary-50 md:h-144 md:bg-primary-300 md:bg-[url('/backgrounds/line.svg')] md:font-bold md:text-primary-900">
