...
export default function Hamburger() {
  return (
    <section className="fixed left-0 top-0 flex w-full flex-row justify-end lg:hidden">
      ...
      <label
        htmlFor="menu-toggle"
        className="fixed right-4 top-4 cursor-pointer mix-blend-difference hover:opacity-80 peer-checked:[&_.burger]:translate-x-10 peer-checked:[&_.cross-line-down]:-rotate-45 peer-checked:[&_.cross-line-up]:rotate-45 peer-checked:[&_.cross]:w-12 peer-checked:[&_.cross]:translate-x-0"
      >
