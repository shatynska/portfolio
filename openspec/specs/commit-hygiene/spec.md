...
TBD - defines local git hook enforcement (commit message linting and staged-file lint/format) for the repository, installed automatically via Husky, with no CI-side re-validation.
